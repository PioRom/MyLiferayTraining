...
import com.symmetry.calculator.model.FooModel;
import com.symmetry.calculator.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final String TABLE_SQL_CREATE = "create table FOO_Foo (uuid_ VARCHAR(75) null,fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.symmetry.calculator.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.symmetry.calculator.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.symmetry.calculator.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.symmetry.calculator.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.symmetry.calculator.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.symmetry.calculator.model.Foo"),
			true);
	public static final long COMPANYID_COLUMN_BITMASK = 1L;
	public static final long GROUPID_COLUMN_BITMASK = 2L;
	public static final long NAME_COLUMN_BITMASK = 4L;
	public static final long UUID_COLUMN_BITMASK = 8L;
	public static final long FOOID_COLUMN_BITMASK = 16L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.symmetry.calculator.service.util.ServiceProps.get(
				"lock.expiration.time.com.symmetry.calculator.model.Foo"));
	...
	public void resetOriginalValues() {
		...
		fooModelImpl._originalName = fooModelImpl._name;
	...
	public String toXmlString() {
		...
		sb.append("com.symmetry.calculator.model.Foo");
