...
import com.symmetry.calculator.exception.NoSuchFooException;
import com.symmetry.calculator.model.Foo;
import com.symmetry.calculator.model.impl.FooImpl;
import com.symmetry.calculator.model.impl.FooModelImpl;
import com.symmetry.calculator.service.persistence.FooPersistence;
 ...
 * @see FooPersistence
 * @see com.symmetry.calculator.service.persistence.FooUtil
 * @generated
 */
@ProviderType
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_NAME = new FinderPath(FooModelImpl.ENTITY_CACHE_ENABLED,
			FooModelImpl.FINDER_CACHE_ENABLED, FooImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_NAME = new FinderPath(FooModelImpl.ENTITY_CACHE_ENABLED,
			FooModelImpl.FINDER_CACHE_ENABLED, FooImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByname",
			new String[] { String.class.getName() },
			FooModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_NAME = new FinderPath(FooModelImpl.ENTITY_CACHE_ENABLED,
			FooModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByname",
			new String[] { String.class.getName() });

	/**
	 * Returns all the foos where name = &#63;.
	 *
	 * @param name the name
	 * @return the matching foos
	 */
	...
	/**
	 * Returns a range of all the foos where name = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FooModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<Foo> findByname(String name, int start, int end) {
		return findByname(name, start, end, null);
	}

	/**
	 * Returns an ordered range of all the foos where name = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FooModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<Foo> findByname(String name, int start, int end,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Foo foo : list) {
					if (!Objects.equals(name, foo.getName())) {
						list = null;
	...
	/**
	 * Returns the first foo in the ordered set where name = &#63;.
	 *
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching foo
	 ...
	 */
	@Override
	public Foo findByname_First(String name,
		OrderByComparator<Foo> orderByComparator) throws NoSuchFooException {
		Foo foo = fetchByname_First(name, orderByComparator);
	 ...
	 */
	@Override
	public Foo fetchByname_First(String name,
		OrderByComparator<Foo> orderByComparator) {
		List<Foo> list = findByname(name, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last foo in the ordered set where name = &#63;.
	 *
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching foo
	 ...
	 */
	@Override
	public Foo findByname_Last(String name,
		OrderByComparator<Foo> orderByComparator) throws NoSuchFooException {
		Foo foo = fetchByname_Last(name, orderByComparator);
	 ...
	 */
	@Override
	public Foo fetchByname_Last(String name,
		OrderByComparator<Foo> orderByComparator) {
		...
		List<Foo> list = findByname(name, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the foos before and after the current foo in the ordered set where name = &#63;.
	 *
	 * @param fooId the primary key of the current foo
	 * @param name the name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Foo[] findByname_PrevAndNext(long fooId, String name,
		OrderByComparator<Foo> orderByComparator) throws NoSuchFooException {
		Foo foo = findByPrimaryKey(fooId);
		...
		try {
			...
			array[0] = getByname_PrevAndNext(session, foo, name,
					orderByComparator, true);

			array[1] = foo;

			array[2] = getByname_PrevAndNext(session, foo, name,
					orderByComparator, false);
	...
	protected Foo getByname_PrevAndNext(Session session, Foo foo, String name,
		OrderByComparator<Foo> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the foos where name = &#63; from the database.
	 *
	 * @param name the name
	 */
	@Override
	public void removeByname(String name) {
		for (Foo foo : findByname(name, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(foo);
		}
	}
	...
	/**
	 * Returns the number of foos where name = &#63;.
	 *
	 * @param name the name
	 * @return the number of matching foos
	 */
	...
	private static final String _FINDER_COLUMN_NAME_NAME_1 = "foo.name IS NULL";
	private static final String _FINDER_COLUMN_NAME_NAME_2 = "foo.name = ?";
	private static final String _FINDER_COLUMN_NAME_NAME_3 = "(foo.name IS NULL OR foo.name = '')";
	...
	public Foo updateImpl(Foo foo) {
		...
		if (!FooModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { fooModelImpl.getName() };
			...
			if ((fooModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { fooModelImpl.getOriginalName() };
