 ...
 * @see FooPersistence
 * @see com.symmetry.calculator.service.persistence.impl.FooPersistenceImpl
 * @generated
 */
@ProviderType
public class FooUtil {
	...
	*/
	public static Foo findByUuid_First(String uuid,
		OrderByComparator<Foo> orderByComparator)
		throws com.symmetry.calculator.exception.NoSuchFooException {
	...
	* @return the range of matching foos
	*/
	public static List<Foo> findByname(String name, int start, int end) {
	...
	* @throws NoSuchFooException if a matching foo could not be found
	*/
	public static Foo findByname_First(String name,
		OrderByComparator<Foo> orderByComparator)
		throws com.symmetry.calculator.exception.NoSuchFooException {
	...
	* @return the first matching foo, or <code>null</code> if a matching foo could not be found
	*/
	public static Foo fetchByname_First(String name,
		OrderByComparator<Foo> orderByComparator) {
	...
	* @throws NoSuchFooException if a matching foo could not be found
	*/
	public static Foo findByname_Last(String name,
		OrderByComparator<Foo> orderByComparator)
		throws com.symmetry.calculator.exception.NoSuchFooException {
	...
	* @return the last matching foo, or <code>null</code> if a matching foo could not be found
	*/
	public static Foo fetchByname_Last(String name,
		OrderByComparator<Foo> orderByComparator) {
	...
	* @throws NoSuchFooException if a foo with the primary key could not be found
	*/
	public static Foo[] findByname_PrevAndNext(long fooId, String name,
		OrderByComparator<Foo> orderByComparator)
		throws com.symmetry.calculator.exception.NoSuchFooException {
		return getPersistence()
				   .findByname_PrevAndNext(fooId, name, orderByComparator);
	}
