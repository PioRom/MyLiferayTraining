 ...
 * @see FooModel
 * @see com.symmetry.calculator.model.impl.FooImpl
 * @see com.symmetry.calculator.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("com.symmetry.calculator.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.symmetry.calculator.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
